	...
	<head>
        ...
        <script type="text/javascript">
			...
			function bxc_option(action) {
				...
				var data = {"action_script":"bxc.sh", "current_page":"Module_BxC.asp", "action_mode":" Refresh "};
				$.ajax({
					type: "POST",
			...
			function bxc_version_check() {
				...
				$.ajax({
			        url: 'https://raw.githubusercontent.com/paldier/softcenter/master/bxc/bxc/version',
			        type: 'GET',
