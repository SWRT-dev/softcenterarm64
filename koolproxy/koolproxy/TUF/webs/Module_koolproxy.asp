...
.kp_btn:hover {
	border: 1px solid #222;
	background: linear-gradient(to bottom, #fcb33a  0%, #92650F 100%); /* W3C */
	font-size:10pt;
	color: #fff;
	padding: 5px 5px;
	border-radius: 5px 5px 5px 5px;
...
function refresh_acl_html() {
	...
	code = code + '<td style="text-align: center;">缺省规则</td>';
	code = code + '<td>';
	code = code + '<select id="koolproxy_acl_default" name="koolproxy_acl_default" style="width:140px;margin:-1px 0px 0px 2px;" class="input_ss_table";">';
							...
							<table width="760px" border="0" cellpadding="5" cellspacing="0" bordercolor="#6b8fa3" class="FormTitle" id="FormTitle" style="border: 0px solid transparent;">
								<tr>
									<td bgcolor="#4D595D" colspan="3" valign="top" style="border-radius: 8px">
										...
										<div id="basic_settings" style="margin:10px 0px 0px 0px;width:748px">
											<table style="margin:-1px 0px 0px 0px;border: 1px solid #000000;width:100%;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable1" id="routing_table">
												<thead>
												<tr>
												...
												<tr id="switch_tr">
													...
													<td colspan="2">
														...
														<div style="display:table-cell;float: left;margin-left:270px;margin-top:-32px;position: absolute;padding: 5.5px 0px;">
															<a type="button" class="kp_btn" target="_blank" href="https://github.com/paldier/softcenter/blob/master/koolproxy/Changelog.txt">更新日志</a>
														</div>
													</td>
												</tr>
												<tr id="kp_status">
												...
												<tr id="policy_tr">
													<th>选择过滤模式</th>
													<td>
														<select name="koolproxy_mode" id="koolproxy_mode" class="input_ss_table" onchange="update_visibility(this);" style="width:auto;margin:0px 0px 0px 2px;">
												...
												<tr id="auto_reboot_switch">
													<th>插件自动重启</th>
													<td>
														<select name="koolproxy_reboot" id="koolproxy_reboot" class="input_ss_table" style="width:auto;margin:0px 0px 0px 2px;" onchange="update_visibility();">
														...
														<span id="koolproxy_reboot_hour_span">
															&nbsp;&nbsp;&nbsp;&nbsp;
															每天
															<select id="koolproxy_reboot_hour" name="koolproxy_reboot_hour" class="ssconfig input_ss_table" >
															</select>
															<select id="koolproxy_reboot_min" name="koolproxy_reboot_min" class="ssconfig input_ss_table" >
															</select>
															重启
															&nbsp;&nbsp;&nbsp;&nbsp;
														</span>
														...
														<span id="koolproxy_reboot_interval_span">
															&nbsp;&nbsp;&nbsp;&nbsp;
															每隔
															<select id="koolproxy_reboot_inter_hour" name="koolproxy_reboot_inter_hour" class="ssconfig input_ss_table" >
															</select>
															<select id="koolproxy_reboot_inter_min" name="koolproxy_reboot_inter_min" class="ssconfig input_ss_table" >
															</select>
															重启koolproxy
															&nbsp;&nbsp;&nbsp;&nbsp;
														</span>
												...
												<tr id="acl_method_tr">
													<th>访问控制匹配方法</th>
													<td>
														<select name="koolproxy_acl_method" id="koolproxy_acl_method" class="input_ss_table" style="width:127px;margin:0px 0px 0px 2px;" onchange="update_visibility();">
										...
										<div id="ACL_table_div" style="margin:10px 0px 0px 0px;width:748px">
											<table id="ACL_table" style="margin:-1px 0px 0px 0px;border: 1px solid #000000;width:100%;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable1" >
												<thead>
												<tr>
												...
												<tr>
													...
													<td>
														<select id="koolproxy_acl_mode" name="koolproxy_acl_mode" style="width:140px;margin:-1px 0px 0px 2px;" class="input_ss_table">
