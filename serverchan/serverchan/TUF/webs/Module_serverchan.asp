...
.serverchan_btn:hover {
    border: 1px solid #222;
    background: linear-gradient(to bottom, #cf951F  0%, #cf950F 100%); /* W3C */
    font-size:10pt;
    color: #fff;
    padding: 5px 5px;
    border-radius: 5px 5px 5px 5px;
                                    ...
                                    <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" style="margin-top:8px;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                a1:b2:c3:d4:e5:f6 #我的手机" cols="50" rows="7" id="serverchan_trigger_dhcp_white" name="serverchan_trigger_dhcp_white" style="width:99%; font-family:'Lucida Console'; font-size:12px;background:transparent;color:#FFFFFF;text-transform:none;margin-top:5px;" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"></textarea>
                                            </td>
                                        </tr>
                                    </table>
                                    <div class="apply_gen">
